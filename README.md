...
> In this tutorial you will know how to create Spring boot 2.2.0 MVC  example in simplest way.
### Project Structure
...
1. Spring 2.2.0.BUILD-SNAPSHOT and any latest version
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<dependencies>
		...
		<!-- this is not use for 2.2.0 version -->
		<!--<dependency>
...
@Configuration
@EnableWebMvc
public class MvcConfig implements WebMvcConfigurer{//extends WebMvcConfigurerAdapter(this class is depricated in 2.2.0 version)
